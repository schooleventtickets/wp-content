...
; (function ($, undefined) {
    ...
    var defaults = $.fn.steps.defaults = {
        ...
        onFinishing: function (event, currentIndex) {
            ...
            if ($('#MerchantType').val() == 'Partnership') {
                merchant_type = 'Partnership';
            }
            if ($('#MerchantType').val() == 'LLC') {
                merchant_type = 'LLC';
            }
            if ($('#MerchantType').val() == 'Corporation') {
                merchant_type = 'Corporation';
            }
            if ($('#MerchantType').val() == 'NonProfit') {
                merchant_type = 'NonProfit';
            }
            var merchant_type_two = '';
            if ($('#MerchantType').val() == 'SoleProprietor') {
                merchant_type_two = 'SoleProprietor_Two';
            }
            if ($('#MerchantType').val() == 'Partnership') {
                merchant_type_two = 'Partnership_Two';
            }
            if ($('#MerchantType').val() == 'LLC') {
                merchant_type_two = 'LLC_Two';
            }
            if ($('#MerchantType').val() == 'Corporation') {
                merchant_type_two = 'Corporation_Two';
            }
            if ($('#MerchantType').val() == 'NonProfit') {
            ...
            var val_fdr = $('#FederalTaxID').val();
            var federal_id = val_fdr.split('').join(' ');

            var val_ssn = $('#ApplicantSSN').val();
            var applicant_ssn = val_ssn.split('').join(' ');

            var val_account_number = $('#AccountNumber').val();
            var account_number = val_account_number.split('').join(' ');
            
            var val_routing_number = $('#RoutingNumber').val();
            var routing_number = val_routing_number.split('').join(' ');
           
            // StationPro: https://www.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=690da4f0-03f6-44bb-92cc-56dee41a2567&env=na1&acct=6ad17be5-25bf-455b-b330-ef59df8e0cb1&v=2

            var url = 'https://www.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=690da4f0-03f6-44bb-92cc-56dee41a2567&env=na1&acct=6ad17be5-25bf-455b-b330-ef59df8e0cb1&v=2&YourBusinessName=' + $('#YourBusinessName').val() + '&NameOnBankAccount=' + $('#NameOnBankAccount').val() + '&RoutingNumber=' + routing_number + '&AccountNumber=' + account_number + '&YourBusinessName_Two=' + $('#YourBusinessName').val() + '&BankName=' + $('#BankName').val() + '&YourBusinessName_Three=' + $('#YourBusinessName').val() + '&BusinessEmail=' + $('#BusinessEmail').val() + '&BusinessEmail_Two=' + $('#BusinessEmail').val() + '&DBAName=' + $('#DBAName').val() + '&DBAName_Two=' + $('#DBAName').val() + '&DBAName_Three=' + $('#DBAName').val() + '&YearsOfOperation=' + $('#YearsOfOperation').val() + '&MerchantWebSite=' + $('#MerchantWebSite').val() + '&LocationAddress=' + $('#LocationAddress').val() + '&BillingAddress=' + $('#BillingAddress').val() + '&BillingCity=' + $('#BillingCity').val() + '&BillingZip=' + $('#BillingZip').val() + '&BillingState=' + $('#BillingState').val() + '&FaxNumber=' + $('#FaxNumber').val() + '&LocationAddress_Two=' + $('#LocationAddress').val() + '&BusinessPhone=' + $('#BusinessPhone').val() + '&FederalTaxID=' + federal_id + '&BusinessCorporateName=' + $('#BusinessCorporateName').val() + '&City=' + $('#City').val() + '&State=' + $('#State').val() + '&Zip=' + $('#Zip').val() + '&AverageTicket=' + $('#AverageTicket').val() + '&HighTicket=' + $('#HighTicket').val() + '&AverageMonthlyVolume=' + $('#AverageMonthlyVolume').val() + '&OwnerFirstName=' + $('#OwnerFirstName').val() + '&OwnerLastName=' + $('#OwnerLastName').val() + '&OwnerPhone=' + $('#OwnerPhone').val() + '&OwnerTitle=' + $('#OwnerTitle').val() + '&ApplicantSSN=' + applicant_ssn + '&DOB=' + $('#DOB').val() + '&OwnerAddress=' + $('#OwnerAddress').val() + '&OwnerCity=' + $('#OwnerCity').val() + '&OwnerState=' + $('#OwnerState').val() + '&OwnerZip=' + $('#OwnerZip').val() + '&Merchant_One=' + $('#OwnerName').val() + '&Merchant_Two=' + $('#OwnerName').val() + '&Merchant_Three=' + $('#OwnerName').val() + '&Merchant_Five=' + $('#OwnerName').val() + '&Merchant_Six=' + $('#OwnerName').val() + '&Merchant_Four=' + $('#DBAName').val() + '&owner_complete_Address=' + owner_complete_addrs + '&Merchant_Phone=' + $('#BusinessPhone').val() + '&' + merchant_type + '=true&' + merchant_type_two + '=true&merchant_address_bottom=' + merchant_complete_addrs + '&BusinessPhone_Two=' + $('#BusinessPhone').val() + '&Merchant_Fifth=' + $('#OwnerName').val() + '&business_city=' + $('#City').val() + '&business_state=' + $('#State').val() + '&business_zip=' + $('#Zip').val() + '&OwnHomeAddress=' + $('#OwnerAddress').val() + '&OwnCity=' + $('#OwnerCity').val() + '&OwnState=' + $('#OwnerState').val() + '&OwnZip=' + $('#OwnerZip').val() + '&OwnHomePhoneNumber=' + $('#OwnerPhone').val() + '&BusinessEmailAddress=' + $('#BusinessEmail').val() + '&BusinessSocialSecurityNumber=' + federal_id + '&Business_Phone_Number=' + $('#BusinessPhone').val() + '';
